function dibujarTablero() {
    ...
    tablero.fillStyle= "#0271ac" //fondo
    tablero.strokeStyle = "#5fb8e8"//linea base
  ...
  function dibujarLineas() {
    ...
    tablero.lineCap="round"
    tablero.lineJoin="round"
    tablero.strokeStyle="52px #19A8AE" //lineas debajo de letras
    tablero.beginPath()
  ...
  function escrribirLetraCorrecta(index) {
    ...
    tablero.font = 'normal 52px Jolly Lodger';
    tablero.lineWidth=6
    tablero.lineCap="round"
    tablero.lineJoin="round"
    tablero.fillStyle= "#bce7fc"//color de letra
    let ancho=600/palabraSecreta.length
  ...
  function perdiste() {
    tablero.font = 'normal 42px Jolly Lodger';
    tablero.lineWidth=6
    tablero.lineCap="round"
    tablero.lineJoin="round"
    tablero.fillStyle="orange"
    tablero.fillText("Fin del juego, perdiste!",930,320)
  }
